...
export async function generateMetadata({
  ...
  const descriptions: Record<Locale, string> = {
    ...
    uk: "Гіпнотерапевт онлайн — Михайло Коломийцев. 200+ клієнтів, 5 років досвіду. Позбавлення від страхів, тривоги, прокрастинації, залежностей. 100% гарантія результату.",
